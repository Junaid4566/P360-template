		...
		return this.each(function () {
			!(function (t) {
				if (2 == jQuery(t).children().length) {
					...
					w.setAttribute(
						"style",
						"position:absolute;width:72px;height:72px;line-height:70px;padding:4xp;text-align:center;top:50%;left:50%;transform:translate(-50%,-50%);border-radius:50%;background-color:#000000;border:5px solid #fff"
					);
